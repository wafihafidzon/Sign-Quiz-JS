...
const questions = [
  {
    questionText: "./assets/images/sign/no-parking.png",
    options: [
    ...
    answer: "No parking allowed",
  },
  {
    questionText: "./assets/images/sign/four-way-intersection.png",
    options: [
    ...
    answer: "A four-way intersection ahead",
  },
  {
    questionText: "./assets/images/sign/two-way-traffic.png",
    options: [
  ...
  {
    questionText: "./assets/images/sign/u-turn-prohibitory.png",
    options: [
      "No left turn.", 
      "Left lane ends.",
      "No left lane.", 
    ...
    answer: "U-turn is prohibited.",
  },
  {
    questionText: "./assets/images/sign/warning-right-curve.png",
    options: [
    ...
    answer: "Warning of a right curve ahead.",
  },
];
...
function displayQuestion() {
  ...
  let h2QuestionElement = document.querySelector("#question-image");
  h2QuestionElement.src = question.questionText;
...
function endQuiz() {
  ...
  score.textContent = scoreValue + time;
}
